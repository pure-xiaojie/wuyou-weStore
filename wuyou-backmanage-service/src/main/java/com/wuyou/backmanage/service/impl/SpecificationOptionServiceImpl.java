...
import com.wuyou.pojo.TbSpecificationOptionExample.Criteria;
import com.wuyou.backmanage.service.SpecificationOptionService;
...
public class SpecificationOptionServiceImpl implements SpecificationOptionService {
	...
	public void delete(Long[] ids) {
		...
		@Override
	public PageResult findPage2(TbSpecificationOption specificationOption, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
