...
import com.wuyou.mapper.TbSellerMapper;
import com.wuyou.pojo.TbSeller;
import com.wuyou.pojo.TbSellerExample;
import com.wuyou.pojo.TbSellerExample.Criteria;
import com.wuyou.backmanage.service.SellerService;
...
public class SellerServiceImpl implements SellerService {
	...
	public void delete(String[] ids) {
		...
		@Override
	public PageResult findPage2(TbSeller seller, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
