...
import com.wuyou.pojo.TbGoodsDescExample;
import com.wuyou.pojo.TbGoodsDescExample.Criteria;
import com.wuyou.backmanage.service.GoodsDescService;
...
public class GoodsDescServiceImpl implements GoodsDescService {
	...
	@Override
	public PageResult findPage2(TbGoodsDesc goodsDesc, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
